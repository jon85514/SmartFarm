...
public class TestMain {
	public static void main(String args[]) {
		...
		barn1.accept(purchasePriceVisitor);
		purchasePrice = purchasePriceVisitor.visit(barn1);
		
		System.out.println("Purchase Price is: " + purchasePrice);
		
		double marketValue;
		Visitor marketValueVisitor = new MarketValueVisitor();
		barn1.accept(marketValueVisitor);
		marketValue = marketValueVisitor.visit(barn1);
