...
import com.farm.view.SmartFarmDashboardController;


public class TelloDroneAdapter extends SmartFarmDashboardController implements FlightAnimation {
	...
	public void visitItem(Item item) {
		...
		try {
			...
			telloDrone.flyBackward(yPos/ Constants.PIXELS_TO_ONE_MODEL_FOOT * Constants.CENTIMETERS_PER_MODEL_FOOT);
			telloDrone.flyRight(xPos / Constants.PIXELS_TO_ONE_MODEL_FOOT * Constants.CENTIMETERS_PER_MODEL_FOOT);
			telloDrone.land();
			} catch (Exception e) {
				e.printStackTrace();
			}
